...
type ComplexityRoot struct {
	...
	Query struct {
		...
		ViewJobByID     func(childComplexity int, jid string) int
	}
...
type QueryResolver interface {
	...
	ViewJobByID(ctx context.Context, jid string) (*model.Job, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.ViewJobById":
		...
		return e.complexity.Query.ViewJobByID(childComplexity, args["jid"].(string)), true
...
func (ec *executionContext) _Job_Desc(ctx context.Context, field graphql.CollectedField, obj *model.Job) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Job_Desc(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_Job_Desc(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Job",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) fieldContext_Mutation_CreateJob(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "Desc":
				return ec.fieldContext_Job_Desc(ctx, field)
			case "Cid":
...
func (ec *executionContext) _Query_ViewJobById(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().ViewJobByID(rctx, fc.Args["jid"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputNewJob(ctx context.Context, obj interface{}) (model.NewJob, error) {
	...
	fieldsInOrder := [...]string{"Title", "Desc", "Cid"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
